(Q05.01) RĪCĪBAS SECĪBA NEGADĪJUMA VIETĀ: Cietušo pārvietošanas iespējas.

* Rīcības negadījuma vietā vispārējie pamatprincipi:  
  * Sargā sevi!  
  * Saglabā mieru!  
...
* Pārbaudi cietušā samaņu: saudzīgi papurini cietušo aiz pleciem un skaļi uzrunā cietušo  
...
(Q05.03) Atdzīvināšanas pasākumi: Cietušais bezsamaņā, neelpo.
...
(Q05.04) DZĪVĪBAI BĪSTAMA ASIŅOŠANA: Šoks. Stipra asiņošana. Stipra asiņošana rokā vai kājā un ir pieejami pārsienamie materiāli.
...
(Q05.05) TERMISKIE BOJĀJUMI: Pārkaršana. Apdegumi
...
(Q05.06) TERMISKIE BOJĀJUMI: Atdzišana, hipotermija. Apsaldējumi.

* novieto cietušo siltā telpā  
...
(Q05.07) ĶĪMISKO VIELU IZRAISĪTIE NELAIMES GADĪJUMI: Ķīmiska viela uz ādas.  Ķīmiska viela acī.

* Kā rīkoties, ja ķīmiska viela uz ādas:  
...
(Q05.08) ĶĪMISKO VIELU IZRAISĪTIE NELAIMES GADĪJUMI: Ķīmiska viela gremošanas traktā. Ieelpota ķīmiska viela

* Kā rīkoties, ja ķīmiska viela gremošanas traktā?  
  1. Izsauc NMP.  
...
1. Glāb cietušo tikai tad, kad tas neapdraud Tavu dzīvību.  
   2. Sargies no slīcēja tvēriena.  
   3. Vienmēr izsauc NMP.  
   4. Atdzīvināšanas pasākumi, ja nepieciešams.

(Q05.11) TRAUMAS: Brūces. Roku un kāju traumas

1. Netīru nobrāzumu vai virspusēju brūci pirms pārsiešanas var noskalot ar tīru ūdeni.  
   2. Pārsien tikai ar sausiem, vēlam steriliem pārsējiem.

(Q05.12) TRAUMAS: Mugurkaula traumas. Vēdera traumas.

1. Aicini cietušo nekustēties, negrozīt galvu.  
   2. Nekustini, nepārvieto cietušo pats! Neļauj cietušo kustināt citiem!  
   3. Izsauc NMP.  
   4. Aprūpē, nomierini cietušo.

(Q05.13) TRAUMAS: Krūškurvja traumas. Galvas traumas

1. Palīdzi / Ļauj cietušajam ieņemt ērtāko ķermeņa pozu.  
   2. Izsauc NMP.  
...
(Q05.15) DZĪVNIEKU IZRAISĪTI NELAIMES GADĪJUMI: Dzīvnieku kostas brūces. Insektu kodumi mutes dobumā.
...
(Q05.16) SVEŠĶERMEŅI: Svešķermenis elpceļos.

1. Pajautā, vai cietušais ir aizrijies.  
...
(Q05.17) SVEŠĶERMEŅI: Svešķermenis brūcē. Svešķermenis acī. Svešķermenis ausī.

* Svešķermenis brūcē. Kā rīkoties?  
...
(Q05.18) SLIMĪBAS: Krampji. Sāpes krūtīs vai elpas trūkums.

1. Nodrošini cietušajiem mieru un svaigu gaisu.  
...
(Q05.19) SLIMĪBAS: Sāpes vēderā. Cukura diabēts. Insults.

* Insults ir galvas smadzeņu bojājums, kura cēlonis ir asinsrites traucējumi galvas smadzenēs, kas apdraud cietušā dzīvību.  
